        ...
        <div className='ForumPage'>
            ...
            <Link to=''>
                <button className='botonChat1'>
                    <img src='https://www.cuerpomente.com/medio/2019/07/03/semillas-de-chia-propiedades_76de1168_846x846.jpg' className='chat1Image'/>
                </button>
            </Link>
            ...
            <Link to=''>
                <button className='botonChat2'>
                    <img src='https://lamenteesmaravillosa.com/wp-content/uploads/2015/04/acosador.jpg' className='chat2Image'/>
                </button>
            </Link>
            <h3>AYUDA!</h3>
